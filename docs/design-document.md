...
| Task Description           | Live WYSIWYG markdown editor (TipTap/ProseMirror). Supports headings, bold, italic, strikethrough, inline code, code blocks with syntax highlighting, bullet/numbered lists, links, and tables. Markdown is rendered inline as you type (no edit/preview toggle). Raw markdown string stored in CRDT for sync.                                                                                                           | P1       |
